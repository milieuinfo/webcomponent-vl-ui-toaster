(function (global, factory) {
  ...
  var _observeToaster = function _observeToaster(event) {
    ...
    if (event[0].addedNodes.length > 0) {
      ...
      _bindCloseButtons(newAlert.querySelectorAll(".".concat(alertCloseClass)));
    ...
    _createClass(Toaster, [{
      ...
      value: function dress(toaster) {
        ...
        var observer = new window.MutationObserver(_observeToaster),
            actions = toaster.querySelectorAll(".".concat(alertCloseClass));
      ...
      value: function dressAll() {
        ...
        var elements = document.querySelectorAll(".".concat(toasterClass, ":not([").concat(toasterDressedAtt, "]):not([data-").concat(vl.ns, "js-dress=\"false\"]),\n      [").concat(toasterAtt, "]:not([").concat(toasterDressedAtt, "]):not([data-").concat(vl.ns, "js-dress=\"false\"])"));
